<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="frmVerFacturaCompra.aspx.cs" Inherits="La_Zarzuela_WEB.Paginas.WebForm4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:Label ID="lblFacturasCompra" runat="server" Text="Facturas de compra" CssClass="h1"></asp:Label>
