<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="VerProveedor.aspx.cs" Inherits="La_Zarzuela_WEB.Paginas.WebForm7" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group" style="display: inline-block; width: 50%;">
        ...
        <asp:TextBox ID="txtDireccion" CssClass="centro" runat="server" OnTextChanged="txtDireccion_TextChanged"></asp:TextBox>
    </div>
    ...
    <div class="form-group" style="display: inline-block; width: 50%;">
        ...
        <asp:TextBox ID="txtCorreo" CssClass="centro" runat="server" ></asp:TextBox>
    </div>
